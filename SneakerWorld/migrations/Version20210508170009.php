 ...
 */
final class Version20210508170009 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment_sneaker ADD prenom VARCHAR(255) NOT NULL');
        ...
        $this->addSql('ALTER TABLE sneaker ADD nom VARCHAR(255) NOT NULL');
    }

    public function down(Schema $schema) : void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE comment_sneaker DROP prenom');
        ...
        $this->addSql('ALTER TABLE sneaker DROP nom');
    }
}
