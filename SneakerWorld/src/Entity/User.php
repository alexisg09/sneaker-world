...
class User
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=CommentSneaker::class, mappedBy="id_헧ser")
     */
    ...
    public function removeCommentSneaker(CommentSneaker $commentSneaker): self
    {
        if ($this->comment_sneaker->removeElement($commentSneaker)) {
            ...
            if ($commentSneaker->getId헧ser() === $this) {
                $commentSneaker->setId헧ser(null);
            }
        }
